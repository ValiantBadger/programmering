...
lines = [
    Line("Red", [0, 1, 2, 4, 5, 6]),
    Line("Green", [7, 8, 9, 10, 11, 12]),
]
...
passenger_names = ["Goonalisa", "Bob the rizzler", "Chadron", "Cringezilla", "Rizzus Maximus", "Goonericus", "Simp Slayer", "Tuah", "Sunshine King", "LeSunshine", "Solar LeBron", "Crazyfrog"]
